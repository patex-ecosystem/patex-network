...
// PatexMintableERC20FactoryABI is the input ABI used to generate the binding from.
// Deprecated: Use PatexMintableERC20FactoryMetaData.ABI instead.
var PatexMintableERC20FactoryABI = PatexMintableERC20FactoryMetaData.ABI

// PatexMintableERC20FactoryBin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use PatexMintableERC20FactoryMetaData.Bin instead.
...
func DeployPatexMintableERC20Factory(auth *bind.TransactOpts, backend bind.ContractBackend, _bridge common.Address) (common.Address, *types.Transaction, *PatexMintableERC20Factory, error) {
	parsed, err := PatexMintableERC20FactoryMetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(PatexMintableERC20FactoryBin), backend, _bridge)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &PatexMintableERC20Factory{PatexMintableERC20FactoryCaller: PatexMintableERC20FactoryCaller{contract: contract}, PatexMintableERC20FactoryTransactor: PatexMintableERC20FactoryTransactor{contract: contract}, PatexMintableERC20FactoryFilterer: PatexMintableERC20FactoryFilterer{contract: contract}}, nil
}

// PatexMintableERC20Factory is an auto generated Go binding around an Ethereum contract.
type PatexMintableERC20Factory struct {
	PatexMintableERC20FactoryCaller     // Read-only binding to the contract
	PatexMintableERC20FactoryTransactor // Write-only binding to the contract
	PatexMintableERC20FactoryFilterer   // Log filterer for contract events
}
...
// PatexMintableERC20FactorySession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type PatexMintableERC20FactorySession struct {
	Contract     *PatexMintableERC20Factory // Generic contract binding to set the session for
	CallOpts     bind.CallOpts                 // Call options to use throughout this session
	TransactOpts bind.TransactOpts             // Transaction auth options to use throughout this session
}

// PatexMintableERC20FactoryCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type PatexMintableERC20FactoryCallerSession struct {
	Contract *PatexMintableERC20FactoryCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts                       // Call options to use throughout this session
}

// PatexMintableERC20FactoryTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type PatexMintableERC20FactoryTransactorSession struct {
	Contract     *PatexMintableERC20FactoryTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts                       // Transaction auth options to use throughout this session
}
...
func NewPatexMintableERC20Factory(address common.Address, backend bind.ContractBackend) (*PatexMintableERC20Factory, error) {
	contract, err := bindPatexMintableERC20Factory(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &PatexMintableERC20Factory{PatexMintableERC20FactoryCaller: PatexMintableERC20FactoryCaller{contract: contract}, PatexMintableERC20FactoryTransactor: PatexMintableERC20FactoryTransactor{contract: contract}, PatexMintableERC20FactoryFilterer: PatexMintableERC20FactoryFilterer{contract: contract}}, nil
}
...
func NewPatexMintableERC20FactoryCaller(address common.Address, caller bind.ContractCaller) (*PatexMintableERC20FactoryCaller, error) {
	contract, err := bindPatexMintableERC20Factory(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &PatexMintableERC20FactoryCaller{contract: contract}, nil
}
...
func NewPatexMintableERC20FactoryTransactor(address common.Address, transactor bind.ContractTransactor) (*PatexMintableERC20FactoryTransactor, error) {
	contract, err := bindPatexMintableERC20Factory(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &PatexMintableERC20FactoryTransactor{contract: contract}, nil
}
...
func NewPatexMintableERC20FactoryFilterer(address common.Address, filterer bind.ContractFilterer) (*PatexMintableERC20FactoryFilterer, error) {
	contract, err := bindPatexMintableERC20Factory(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &PatexMintableERC20FactoryFilterer{contract: contract}, nil
}

// bindPatexMintableERC20Factory binds a generic wrapper to an already deployed contract.
func bindPatexMintableERC20Factory(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(PatexMintableERC20FactoryABI))
	if err != nil {
		return nil, err
	}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _PatexMintableERC20Factory.Contract.PatexMintableERC20FactoryCaller.contract.Call(opts, result, method, params...)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _PatexMintableERC20Factory.Contract.PatexMintableERC20FactoryTransactor.contract.Transfer(opts)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _PatexMintableERC20Factory.Contract.PatexMintableERC20FactoryTransactor.contract.Transact(opts, method, params...)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _PatexMintableERC20Factory.Contract.contract.Call(opts, result, method, params...)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _PatexMintableERC20Factory.Contract.contract.Transfer(opts)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _PatexMintableERC20Factory.Contract.contract.Transact(opts, method, params...)
}

// BRIDGE is a free data retrieval call binding the contract method 0xee9a31a2.
//
// Solidity: function BRIDGE() view returns(address)
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryCaller) BRIDGE(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _PatexMintableERC20Factory.contract.Call(opts, &out, "BRIDGE")
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactorySession) BRIDGE() (common.Address, error) {
	return _PatexMintableERC20Factory.Contract.BRIDGE(&_PatexMintableERC20Factory.CallOpts)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryCaller) Version(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _PatexMintableERC20Factory.contract.Call(opts, &out, "version")
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactorySession) Version() (string, error) {
	return _PatexMintableERC20Factory.Contract.Version(&_PatexMintableERC20Factory.CallOpts)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryTransactor) CreatePatexMintableERC20(opts *bind.TransactOpts, _remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _PatexMintableERC20Factory.contract.Transact(opts, "createPatexMintableERC20", _remoteToken, _name, _symbol)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactorySession) CreatePatexMintableERC20(_remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _PatexMintableERC20Factory.Contract.CreatePatexMintableERC20(&_PatexMintableERC20Factory.TransactOpts, _remoteToken, _name, _symbol)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryTransactor) CreateStandardL2Token(opts *bind.TransactOpts, _remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _PatexMintableERC20Factory.contract.Transact(opts, "createStandardL2Token", _remoteToken, _name, _symbol)
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactorySession) CreateStandardL2Token(_remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _PatexMintableERC20Factory.Contract.CreateStandardL2Token(&_PatexMintableERC20Factory.TransactOpts, _remoteToken, _name, _symbol)
}
...
type PatexMintableERC20FactoryPatexMintableERC20CreatedIterator struct {
	Event *PatexMintableERC20FactoryPatexMintableERC20Created // Event containing the contract specifics and raw log
...
func (it *PatexMintableERC20FactoryPatexMintableERC20CreatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PatexMintableERC20FactoryPatexMintableERC20Created)
...
type PatexMintableERC20FactoryPatexMintableERC20Created struct {
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryFilterer) FilterPatexMintableERC20Created(opts *bind.FilterOpts, localToken []common.Address, remoteToken []common.Address) (*PatexMintableERC20FactoryPatexMintableERC20CreatedIterator, error) {
	...
	logs, sub, err := _PatexMintableERC20Factory.contract.FilterLogs(opts, "PatexMintableERC20Created", localTokenRule, remoteTokenRule)
	if err != nil {
		return nil, err
	}
	return &PatexMintableERC20FactoryPatexMintableERC20CreatedIterator{contract: _PatexMintableERC20Factory.contract, event: "PatexMintableERC20Created", logs: logs, sub: sub}, nil
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryFilterer) WatchPatexMintableERC20Created(opts *bind.WatchOpts, sink chan<- *PatexMintableERC20FactoryPatexMintableERC20Created, localToken []common.Address, remoteToken []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _PatexMintableERC20Factory.contract.WatchLogs(opts, "PatexMintableERC20Created", localTokenRule, remoteTokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(PatexMintableERC20FactoryPatexMintableERC20Created)
				if err := _PatexMintableERC20Factory.contract.UnpackLog(event, "PatexMintableERC20Created", log); err != nil {
					return err
				}
				event.Raw = log
...
type PatexMintableERC20FactoryStandardL2TokenCreatedIterator struct {
	Event *PatexMintableERC20FactoryStandardL2TokenCreated // Event containing the contract specifics and raw log
...
func (it *PatexMintableERC20FactoryStandardL2TokenCreatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PatexMintableERC20FactoryStandardL2TokenCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type PatexMintableERC20FactoryStandardL2TokenCreated struct {
	RemoteToken common.Address
	LocalToken  common.Address
	Raw         types.Log // Blockchain specific contextual infos
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryFilterer) FilterStandardL2TokenCreated(opts *bind.FilterOpts, remoteToken []common.Address, localToken []common.Address) (*PatexMintableERC20FactoryStandardL2TokenCreatedIterator, error) {
	...
	logs, sub, err := _PatexMintableERC20Factory.contract.FilterLogs(opts, "StandardL2TokenCreated", remoteTokenRule, localTokenRule)
	if err != nil {
		return nil, err
	}
	return &PatexMintableERC20FactoryStandardL2TokenCreatedIterator{contract: _PatexMintableERC20Factory.contract, event: "StandardL2TokenCreated", logs: logs, sub: sub}, nil
}
...
func (_PatexMintableERC20Factory *PatexMintableERC20FactoryFilterer) WatchStandardL2TokenCreated(opts *bind.WatchOpts, sink chan<- *PatexMintableERC20FactoryStandardL2TokenCreated, remoteToken []common.Address, localToken []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _PatexMintableERC20Factory.contract.WatchLogs(opts, "StandardL2TokenCreated", remoteTokenRule, localTokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PatexMintableERC20FactoryStandardL2TokenCreated)
				if err := _PatexMintableERC20Factory.contract.UnpackLog(event, "StandardL2TokenCreated", log); err != nil {
					return err
				}
				event.Raw = log
