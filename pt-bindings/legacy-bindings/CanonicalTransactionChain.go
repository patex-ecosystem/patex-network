...
// LibPVMCodecQueueElement is an auto generated low-level Go binding around an user-defined struct.
type LibPVMCodecQueueElement struct {
...
func (_CanonicalTransactionChain *CanonicalTransactionChainCaller) GetQueueElement(opts *bind.CallOpts, _index *big.Int) (LibPVMCodecQueueElement, error) {
	var out []interface{}
	err := _CanonicalTransactionChain.contract.Call(opts, &out, "getQueueElement", _index)

	if err != nil {
		return *new(LibPVMCodecQueueElement), err
	}

	out0 := *abi.ConvertType(out[0], new(LibPVMCodecQueueElement)).(*LibPVMCodecQueueElement)
...
//
// Solidity: function getQueueElement(uint256 _index) view returns((bytes32,uint40,uint40) _element)
func (_CanonicalTransactionChain *CanonicalTransactionChainSession) GetQueueElement(_index *big.Int) (LibPVMCodecQueueElement, error) {
...
//
// Solidity: function getQueueElement(uint256 _index) view returns((bytes32,uint40,uint40) _element)
func (_CanonicalTransactionChain *CanonicalTransactionChainCallerSession) GetQueueElement(_index *big.Int) (LibPVMCodecQueueElement, error) {
	return _CanonicalTransactionChain.Contract.GetQueueElement(&_CanonicalTransactionChain.CallOpts, _index)
}
