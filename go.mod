module github.com/patex-ecosystem/patex-network
...
require (
	...
	github.com/patex-ecosystem/go-ethereum-hdwallet v0.1.3
...
replace github.com/ethereum/go-ethereum v1.11.5 => github.com/patex-ecosystem/patex-chain v1.0.6
