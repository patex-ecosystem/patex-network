...
import (
	...
	opcrypto "github.com/patex-ecosystem/patex-network/pt-service/crypto"
	"github.com/patex-ecosystem/patex-network/pt-signer/client"
...
const (
	...
	// Key Management Flags (also have pt-signer client flags)
...
var (
	SequencerHDPathFlag = cli.StringFlag{
		...
		EnvVar: "PT_BATCHER_SEQUENCER_HD_PATH",
	}
	L2OutputHDPathFlag = cli.StringFlag{
		...
		Usage: "DEPRECATED:The HD path used to derive the l2output wallet from the " +
			"mnemonic. The mnemonic flag must also be set.",
		EnvVar: "PT_PROPOSER_L2_OUTPUT_HD_PATH",
	}
)
