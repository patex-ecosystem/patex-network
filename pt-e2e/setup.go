...
import (
	...
	bss "github.com/patex-ecosystem/patex-network/pt-batcher/batcher"
	batchermetrics "github.com/patex-ecosystem/patex-network/pt-batcher/metrics"
	...
	"github.com/patex-ecosystem/patex-network/pt-e2e/e2eutils"
	...
	rollupNode "github.com/patex-ecosystem/patex-network/pt-node/node"
	"github.com/patex-ecosystem/patex-network/pt-node/p2p"
	"github.com/patex-ecosystem/patex-network/pt-node/rollup"
	"github.com/patex-ecosystem/patex-network/pt-node/rollup/driver"
	"github.com/patex-ecosystem/patex-network/pt-node/sources"
	"github.com/patex-ecosystem/patex-network/pt-node/testlog"
	proposermetrics "github.com/patex-ecosystem/patex-network/pt-proposer/metrics"
	l2os "github.com/patex-ecosystem/patex-network/pt-proposer/proposer"
...
func DefaultSystemConfig(t *testing.T) SystemConfig {
	...
	deployConfig := &genesis.DeployConfig{
		...
		CliqueSignerAddress:         common.Address{}, // pt-e2e used to run Clique, but now uses fake Proof of Stake.
...
func (cfg SystemConfig) Start(_opts ...SystemConfigOption) (*System, error) {
	...
	makeRollupConfig := func() rollup.Config {
		return rollup.Config{
			...
			DepositContractAddress: predeploys.DevPatexPortalAddr,
	...
	}, sys.cfg.Loggers["proposer"], proposermetrics.Noptmetrics)
	if err != nil {
	...
	}, sys.cfg.Loggers["batcher"], batchermetrics.Noptmetrics)
	if err != nil {
...
func configureL1(rollupNodeCfg *rollupNode.Config, l1Node *node.Node) {
	...
	useHTTP := os.Getenv("PT_E2E_USE_HTTP") == "true"
	if useHTTP {
