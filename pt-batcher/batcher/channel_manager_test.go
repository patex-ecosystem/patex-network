...
import (
	...
	derivetest "github.com/patex-ecosystem/patex-network/pt-node/rollup/derive/test"
...
func TestChannelManagerReturnsErrReorg(t *testing.T) {
	...
	m := NewChannelManager(log, metrics.Noptmetrics, ChannelConfig{})
...
func TestChannelManagerReturnsErrReorgWhenDrained(t *testing.T) {
	log := testlog.Logger(t, log.LvlCrit)
	m := NewChannelManager(log, metrics.Noptmetrics,
		ChannelConfig{
