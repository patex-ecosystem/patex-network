...
import (
	...
	opclient "github.com/patex-ecosystem/patex-network/pt-service/client"
...
func (l *BatchSubmitter) calculateL2BlockRangeToStore(ctx context.Context) (eth.BlockID, eth.BlockID, error) {
	...
	// It lagging implies that the pt-node processed some batches that were submitted prior to the current instance of the batcher being alive.
