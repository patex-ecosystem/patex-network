...
import (
	...
	"github.com/patex-ecosystem/patex-network/pt-chain-ops/ether"
...
var (
	...
	ExpectedStorageSlots = map[common.Address]StorageCheckMap{
		...
		predeploys.PatexMintableERC20FactoryAddr: eip1967Slots(predeploys.PatexMintableERC20FactoryAddr),
		...
		predeploys.PatexMintableERC721FactoryAddr: eip1967Slots(predeploys.PatexMintableERC721FactoryAddr),
