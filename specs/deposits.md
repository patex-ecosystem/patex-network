...
- [User-Deposited Transactions](#user-deposited-transactions)
  - [Deposit Contract](#deposit-contract)
    ...
    - [Deposit Contract Implementation: Patex Portal](#deposit-contract-implementation-Patex-portal)
...
2. an array of zero-or-more [user-deposited transactions][user-deposited]
   submitted to the deposit feed contract on L1 (called `PatexPortal`).
...
1. `from` is unchanged from the emitted value (though it may
   have been transformed to an alias in `PatexPortal`, the deposit feed contract).
...
#### Deposit Contract Implementation: Patex Portal

A reference implementation of the deposit contract can be found in [PatexPortal.sol].

[PatexPortal.sol]: https://github.com/patex-ecosystem/contracts-bedrock/blob/main/contracts/L1/PatexPortal.sol
