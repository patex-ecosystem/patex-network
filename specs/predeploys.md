...
- [PatexMintableERC20Factory](#patexmintableerc20factory)
- [PatexMintableERC721Factory](#patexmintableerc721factory)
...
[Predeployed smart contracts](./glossary.md#predeployed-contract-predeploy) exist on Patex
...
| PatexMintableERC20Factory  | 0x4200000000000000000000000000000000000012 | Legacy     | No         | Yes     |
...
| PatexMintableERC721Factory | 0x4200000000000000000000000000000000000017 | Bedrock    | No         | Yes     |
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/legacy/LegacyMessagePasser.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/L2/L2ToL1MessagePasser.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/legacy/DeployerWhitelist.sol)

Address: `0x4200000000000000000000000000000000000002`

The `DeployerWhitelist` is a predeploy that was used to provide additional safety
during the initial phases of Patex.
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/legacy/LegacyERC20ETH.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/L2/L2CrossDomainMessenger.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/L2/L2StandardBridge.sol)
...
The `PatexMintableERC20Factory` can be used to create an ERC20 token contract
...
`PatexMintableERC20` which has the interface that works with the
`StandardBridge`.
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/legacy/L1BlockNumber.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/L2/GasPriceOracle.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/L2/L1Block.sol)
...
[ProxyAdmin](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/universal/ProxyAdmin.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/L2/SequencerFeeVault.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/universal/PatexMintableERC20Factory.sol)

Address: `0x4200000000000000000000000000000000000012`

The `PatexMintableERC20Factory` is responsible for creating ERC20 contracts on L2 that can be
...
Each ERC20 contract that is created by the `PatexMintableERC20Factory` allows for the `L2StandardBridge` to mint
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/universal/PatexMintableERC721Factory.sol)

Address: `0x4200000000000000000000000000000000000017`

The `PatexMintableERC721Factory` is responsible for creating ERC721 contracts on L2 that can be used for
depositing native L1 NFTs into.

## BaseFeeVault

[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/L2/BaseFeeVault.sol)
...
[Implementation](https://github.com/patex-ecosystem/contracts-bedrock/tree/main/contracts/L2/L1FeeVault.sol)
