...
- [Foundations](#foundations)
  ...
  - [What is an Patex Rollup?](#what-is-an-patex-rollup)
...
Patex is an _EVM equivalent_, _patex rollup_ protocol designed to _scale Ethereum_ while remaining maximally
...
### What is an Patex Rollup?

[Patex rollup](https://vitalik.ca/general/2021/01/05/rollup.html) is a layer 2 scalability technique which
...
[EVM Equivalence](https://medium.com/ethereum-Patex/introducing-evm-equivalence-5c2021deb306) is complete compliance
...
**Patex is an _EVM equivalent_, _patex rollup_ protocol designed to _scale Ethereum_.**
...
**Footnote**: There are two main ways to enforce validity of a rollup: fault proofs (patex rollup) and validity
...
There are three actors in Patex: users, sequencers, and verifiers.
...
For 1.0.0, there is just one sequencer (currently operated under the oversight of the Patex Foundation).
...
The following diagram demonstrates this interaction and all key Patex components which are or should be utilized:
