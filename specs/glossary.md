...
Refers the Ethereum blockchain, used in contrast to [layer 2][L2], which refers to Patex.

## Layer 2 (L2)

[L2]: glossary.md#layer-2-L2

Refers to the Patex blockchain (specified in this repository), used in contrast to [layer 1][L1], which
...
window. In Patex's case, the data in question are [sequencer batches][sequencer-batch] that [validators][validator]
