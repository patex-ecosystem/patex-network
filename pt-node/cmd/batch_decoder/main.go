...
import (
	...
	"github.com/patex-ecosystem/patex-network/pt-node/cmd/batch_decoder/fetch"
	"github.com/patex-ecosystem/patex-network/pt-node/cmd/batch_decoder/reassemble"
...
func main() {
	...
	app.Usage = "Patex Batch Decoding Utility"
