...
// The PtNode handles incoming gossip
var _ p2p.GossipIn = (*PtNode)(nil)
...
func (n *PtNode) init(ctx context.Context, cfg *Config, snapshotLog log.Logger) error {
...
func (n *PtNode) initTracer(ctx context.Context, cfg *Config) error {
	if cfg.Tracer != nil {
		n.tracer = cfg.Tracer
	} else {
...
func (n *PtNode) initL1(ctx context.Context, cfg *Config) error {
...
func (n *PtNode) initRuntimeConfig(ctx context.Context, cfg *Config) error {
...
func (n *PtNode) initL2(ctx context.Context, cfg *Config, snapshotLog log.Logger) error {
...
func (n *PtNode) initRPCSync(ctx context.Context, cfg *Config) error {
...
func (n *PtNode) initRPCServer(ctx context.Context, cfg *Config) error {
...
func (n *PtNode) initMetricsServer(ctx context.Context, cfg *Config) error {
...
func (n *PtNode) initP2P(ctx context.Context, cfg *Config) error {
	if cfg.P2P != nil {
...
func (n *PtNode) initP2PSigner(ctx context.Context, cfg *Config) error {
